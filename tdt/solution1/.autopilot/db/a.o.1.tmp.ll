; ModuleID = '/home/mrostami/SamimProject/DVE0528/Rotation/AffineTransformation/HLS/tdt_hls/tdt/solution1/.autopilot/db/a.o.1.tmp.bc'
...
define void @tdt(i8 signext %w_div, i8 signext %h_div, i13 signext %d_w, i13 signext %d_h, i13 signext %s_w, i13 signext %s_h, i27 signext %M0, i27 signext %M1, i27 signext %M2, i27 signext %M3, i27 signext %M4, i27 signext %M5, i8 signext %c, i8 signext %r, i15* %hs_p, i15* %hs, i15* %ws, i1* %tile_valid, i12* %left_col, i12* %top_row, i32* %baddr, i13* %cd0, i13* %cd1, i13* %cd2, i13* %cd3, i2* %mod_db) nounwind uwtable {
  ...
  %tmp = sext i8 %w_div to i13, !dbg !253         ; [#uses=2 type=i13] [debug line = 76:24]
  ...
  %tmp.3 = add i13 %tmp, -1, !dbg !255            ; [#uses=1 type=i13] [debug line = 77:32]
  %cd11 = add i13 %tmp.3, %cd00, !dbg !255        ; [#uses=3 type=i13] [debug line = 77:32]
  call void @llvm.dbg.value(metadata !{i13 %cd11}, i64 0, metadata !256), !dbg !255 ; [debug line = 77:32] [debug variable = cd11]
  %tmp.5 = sext i8 %h_div to i13, !dbg !257       ; [#uses=2 type=i13] [debug line = 78:24]
  ...
  %tmp.8 = add i13 %tmp.5, -1, !dbg !259          ; [#uses=1 type=i13] [debug line = 79:33]
  %rd11 = add i13 %tmp.8, %rd00, !dbg !259        ; [#uses=1 type=i13] [debug line = 79:33]
  ...
  %tmp.18 = trunc i13 %tmp.9 to i12, !dbg !268    ; [#uses=1 type=i12] [debug line = 91:3]
  %tmp. = sext i12 %tmp.18 to i13, !dbg !268      ; [#uses=2 type=i13] [debug line = 91:3]
  %tmp.10 = sext i27 %M0 to i32, !dbg !269        ; [#uses=2 type=i32] [debug line = 94:3]
  %tmp.11 = sext i27 %M1 to i32, !dbg !269        ; [#uses=2 type=i32] [debug line = 94:3]
  %tmp.12 = sext i27 %M2 to i32, !dbg !269        ; [#uses=2 type=i32] [debug line = 94:3]
  %tmp.13 = sext i27 %M3 to i32, !dbg !270        ; [#uses=2 type=i32] [debug line = 95:3]
  %tmp.14 = sext i27 %M4 to i32, !dbg !270        ; [#uses=2 type=i32] [debug line = 95:3]
  %tmp.15 = sext i27 %M5 to i32, !dbg !270        ; [#uses=2 type=i32] [debug line = 95:3]
  %tmp.16 = sext i13 %s_w to i32, !dbg !271       ; [#uses=4 type=i32] [debug line = 101:3]
  %tmp.21 = lshr i13 %s_w, 1, !dbg !271           ; [#uses=1 type=i13] [debug line = 101:3]
  %tmp.23 = trunc i13 %tmp.21 to i12, !dbg !271   ; [#uses=1 type=i12] [debug line = 101:3]
  %tmp.17 = sext i12 %tmp.23 to i26, !dbg !271    ; [#uses=4 type=i26] [debug line = 101:3]
  %tmp.19 = sext i13 %s_h to i32, !dbg !272       ; [#uses=3 type=i32] [debug line = 102:3]
  %tmp.25 = lshr i13 %s_h, 1, !dbg !272           ; [#uses=1 type=i13] [debug line = 102:3]
  %tmp.26 = trunc i13 %tmp.25 to i12, !dbg !272   ; [#uses=1 type=i12] [debug line = 102:3]
  %tmp.20 = sext i12 %tmp.26 to i26, !dbg !272    ; [#uses=4 type=i26] [debug line = 102:3]
  %tmp.87 = sub i13 %cd00, %tmp.4, !dbg !265      ; [#uses=1 type=i13] [debug line = 90:3]
  %tmp.27 = sub i13 %rd00, %tmp., !dbg !268       ; [#uses=1 type=i13] [debug line = 91:3]
  %tmp.28 = sext i13 %tmp.87 to i32, !dbg !269    ; [#uses=2 type=i32] [debug line = 94:3]
  %tmp.29 = mul nsw i32 %tmp.10, %tmp.28, !dbg !269 ; [#uses=1 type=i32] [debug line = 94:3]
  %tmp.30 = sext i13 %tmp.27 to i32, !dbg !269    ; [#uses=2 type=i32] [debug line = 94:3]
  %tmp.31 = mul nsw i32 %tmp.11, %tmp.30, !dbg !269 ; [#uses=2 type=i32] [debug line = 94:3]
  %tmp.32 = add i32 %tmp.12, %tmp.29, !dbg !269   ; [#uses=2 type=i32] [debug line = 94:3]
  %tmp.33 = add i32 %tmp.31, %tmp.32, !dbg !269   ; [#uses=1 type=i32] [debug line = 94:3]
  %tmp.35 = mul nsw i32 %tmp.13, %tmp.28, !dbg !270 ; [#uses=1 type=i32] [debug line = 95:3]
  %tmp.36 = mul nsw i32 %tmp.14, %tmp.30, !dbg !270 ; [#uses=2 type=i32] [debug line = 95:3]
  %tmp.37 = add i32 %tmp.15, %tmp.35, !dbg !270   ; [#uses=2 type=i32] [debug line = 95:3]
  %tmp.38 = add i32 %tmp.36, %tmp.37, !dbg !270   ; [#uses=1 type=i32] [debug line = 95:3]
  %tmp.34 = lshr i32 %tmp.33, 15, !dbg !273       ; [#uses=1 type=i32] [debug line = 98:3]
  %tmp.39 = trunc i32 %tmp.34 to i17, !dbg !273   ; [#uses=1 type=i17] [debug line = 98:3]
  %tmp.40 = sext i17 %tmp.39 to i26, !dbg !273    ; [#uses=1 type=i26] [debug line = 98:3]
  %tmp.41 = lshr i32 %tmp.38, 15, !dbg !274       ; [#uses=1 type=i32] [debug line = 99:3]
  %tmp.42 = trunc i32 %tmp.41 to i17, !dbg !274   ; [#uses=1 type=i17] [debug line = 99:3]
  %tmp.43 = sext i17 %tmp.42 to i26, !dbg !274    ; [#uses=1 type=i26] [debug line = 99:3]
  %"cs[0]" = add i26 %tmp.17, %tmp.40, !dbg !271  ; [#uses=3 type=i26] [debug line = 101:3]
  call void @llvm.dbg.value(metadata !{i26 %"cs[0]"}, i64 0, metadata !275), !dbg !271 ; [debug line = 101:3] [debug variable = cs[0]]
  %"rs[0]" = add i26 %tmp.20, %tmp.43, !dbg !272  ; [#uses=3 type=i26] [debug line = 102:3]
  call void @llvm.dbg.value(metadata !{i26 %"rs[0]"}, i64 0, metadata !280), !dbg !272 ; [debug line = 102:3] [debug variable = rs[0]]
  ...
  %tmp.29.1 = mul nsw i32 %tmp.10, %tmp.28.1, !dbg !269 ; [#uses=1 type=i32] [debug line = 94:3]
  %tmp.32.1 = add i32 %tmp.12, %tmp.29.1, !dbg !269 ; [#uses=2 type=i32] [debug line = 94:3]
  %tmp.33.1 = add i32 %tmp.31, %tmp.32.1, !dbg !269 ; [#uses=1 type=i32] [debug line = 94:3]
  %tmp.35.1 = mul nsw i32 %tmp.13, %tmp.28.1, !dbg !270 ; [#uses=1 type=i32] [debug line = 95:3]
  %tmp.37.1 = add i32 %tmp.15, %tmp.35.1, !dbg !270 ; [#uses=2 type=i32] [debug line = 95:3]
  %tmp.38.1 = add i32 %tmp.36, %tmp.37.1, !dbg !270 ; [#uses=1 type=i32] [debug line = 95:3]
  %tmp.44 = lshr i32 %tmp.33.1, 15, !dbg !273     ; [#uses=1 type=i32] [debug line = 98:3]
  %tmp.45 = trunc i32 %tmp.44 to i17, !dbg !273   ; [#uses=1 type=i17] [debug line = 98:3]
  %tmp.46 = sext i17 %tmp.45 to i26, !dbg !273    ; [#uses=1 type=i26] [debug line = 98:3]
  %tmp.49 = lshr i32 %tmp.38.1, 15, !dbg !274     ; [#uses=1 type=i32] [debug line = 99:3]
  %tmp.50 = trunc i32 %tmp.49 to i17, !dbg !274   ; [#uses=1 type=i17] [debug line = 99:3]
  %tmp.53 = sext i17 %tmp.50 to i26, !dbg !274    ; [#uses=1 type=i26] [debug line = 99:3]
  %"cs[1]" = add i26 %tmp.17, %tmp.46, !dbg !271  ; [#uses=3 type=i26] [debug line = 101:3]
  call void @llvm.dbg.value(metadata !{i26 %"cs[1]"}, i64 0, metadata !281), !dbg !271 ; [debug line = 101:3] [debug variable = cs[1]]
  %"rs[1]" = add i26 %tmp.20, %tmp.53, !dbg !272  ; [#uses=3 type=i26] [debug line = 102:3]
  call void @llvm.dbg.value(metadata !{i26 %"rs[1]"}, i64 0, metadata !282), !dbg !272 ; [debug line = 102:3] [debug variable = rs[1]]
  ...
  %tmp.31.2 = mul nsw i32 %tmp.11, %tmp.30.2, !dbg !269 ; [#uses=2 type=i32] [debug line = 94:3]
  %tmp.33.2 = add i32 %tmp.31.2, %tmp.32, !dbg !269 ; [#uses=1 type=i32] [debug line = 94:3]
  %tmp.36.2 = mul nsw i32 %tmp.14, %tmp.30.2, !dbg !270 ; [#uses=2 type=i32] [debug line = 95:3]
  %tmp.38.2 = add i32 %tmp.36.2, %tmp.37, !dbg !270 ; [#uses=1 type=i32] [debug line = 95:3]
  %tmp.55 = lshr i32 %tmp.33.2, 15, !dbg !273     ; [#uses=1 type=i32] [debug line = 98:3]
  %tmp.56 = trunc i32 %tmp.55 to i17, !dbg !273   ; [#uses=1 type=i17] [debug line = 98:3]
  %tmp.58 = sext i17 %tmp.56 to i26, !dbg !273    ; [#uses=1 type=i26] [debug line = 98:3]
  %tmp.61 = lshr i32 %tmp.38.2, 15, !dbg !274     ; [#uses=1 type=i32] [debug line = 99:3]
  %tmp.62 = trunc i32 %tmp.61 to i17, !dbg !274   ; [#uses=1 type=i17] [debug line = 99:3]
  %tmp.65 = sext i17 %tmp.62 to i26, !dbg !274    ; [#uses=1 type=i26] [debug line = 99:3]
  %"cs[2]" = add i26 %tmp.17, %tmp.58, !dbg !271  ; [#uses=3 type=i26] [debug line = 101:3]
  call void @llvm.dbg.value(metadata !{i26 %"cs[2]"}, i64 0, metadata !283), !dbg !271 ; [debug line = 101:3] [debug variable = cs[2]]
  %"rs[2]" = add i26 %tmp.20, %tmp.65, !dbg !272  ; [#uses=3 type=i26] [debug line = 102:3]
  call void @llvm.dbg.value(metadata !{i26 %"rs[2]"}, i64 0, metadata !284), !dbg !272 ; [debug line = 102:3] [debug variable = rs[2]]
  ...
  %tmp.67 = lshr i32 %tmp.33.3, 15, !dbg !273     ; [#uses=1 type=i32] [debug line = 98:3]
  %tmp.75 = trunc i32 %tmp.67 to i17, !dbg !273   ; [#uses=1 type=i17] [debug line = 98:3]
  %tmp.76 = sext i17 %tmp.75 to i26, !dbg !273    ; [#uses=1 type=i26] [debug line = 98:3]
  %tmp.82 = lshr i32 %tmp.38.3, 15, !dbg !274     ; [#uses=1 type=i32] [debug line = 99:3]
  %tmp.83 = trunc i32 %tmp.82 to i17, !dbg !274   ; [#uses=1 type=i17] [debug line = 99:3]
  %tmp.86 = sext i17 %tmp.83 to i26, !dbg !274    ; [#uses=1 type=i26] [debug line = 99:3]
  %"cs[3]" = add i26 %tmp.17, %tmp.76, !dbg !271  ; [#uses=3 type=i26] [debug line = 101:3]
  call void @llvm.dbg.value(metadata !{i26 %"cs[3]"}, i64 0, metadata !285), !dbg !271 ; [debug line = 101:3] [debug variable = cs[3]]
  %"rs[3]" = add i26 %tmp.20, %tmp.86, !dbg !272  ; [#uses=3 type=i26] [debug line = 102:3]
  call void @llvm.dbg.value(metadata !{i26 %"rs[3]"}, i64 0, metadata !286), !dbg !272 ; [debug line = 102:3] [debug variable = rs[3]]
  call void @llvm.dbg.value(metadata !{i26 %"cs[0]"}, i64 0, metadata !287), !dbg !289 ; [debug line = 13:19@110:5] [debug variable = in[0]]
  call void @llvm.dbg.value(metadata !{i26 %"cs[1]"}, i64 0, metadata !290), !dbg !289 ; [debug line = 13:19@110:5] [debug variable = in[1]]
  call void @llvm.dbg.value(metadata !{i26 %"cs[2]"}, i64 0, metadata !291), !dbg !289 ; [debug line = 13:19@110:5] [debug variable = in[2]]
  call void @llvm.dbg.value(metadata !{i26 %"cs[3]"}, i64 0, metadata !292), !dbg !289 ; [debug line = 13:19@110:5] [debug variable = in[3]]
  %tmp.i = icmp sgt i26 %"cs[0]", %"cs[1]", !dbg !293 ; [#uses=2 type=i1] [debug line = 15:2@110:5]
  %"in[1].read.assign" = select i1 %tmp.i, i26 %"cs[1]", i26 %"cs[0]", !dbg !293 ; [#uses=2 type=i26] [debug line = 15:2@110:5]
  call void @llvm.dbg.value(metadata !{i26 %"in[1].read.assign"}, i64 0, metadata !290), !dbg !293 ; [debug line = 15:2@110:5] [debug variable = in[1]]
  call void @llvm.dbg.value(metadata !{i26 %"in[1].read.assign"}, i64 0, metadata !295), !dbg !293 ; [debug line = 15:2@110:5] [debug variable = min1]
  %tmp..i = icmp sgt i26 %"cs[2]", %"cs[3]", !dbg !296 ; [#uses=2 type=i1] [debug line = 16:2@110:5]
  %"in[3].read.assign" = select i1 %tmp..i, i26 %"cs[3]", i26 %"cs[2]", !dbg !296 ; [#uses=2 type=i26] [debug line = 16:2@110:5]
  call void @llvm.dbg.value(metadata !{i26 %"in[3].read.assign"}, i64 0, metadata !292), !dbg !296 ; [debug line = 16:2@110:5] [debug variable = in[3]]
  call void @llvm.dbg.value(metadata !{i26 %"in[3].read.assign"}, i64 0, metadata !297), !dbg !296 ; [debug line = 16:2@110:5] [debug variable = min2]
  %tmp.97.i = icmp sgt i26 %"in[1].read.assign", %"in[3].read.assign", !dbg !298 ; [#uses=1 type=i1] [debug line = 17:2@110:5]
  %min2.1 = select i1 %tmp.97.i, i26 %"in[3].read.assign", i26 %"in[1].read.assign", !dbg !298 ; [#uses=4 type=i26] [debug line = 17:2@110:5]
  call void @llvm.dbg.value(metadata !{i26 %min2.1}, i64 0, metadata !297), !dbg !298 ; [debug line = 17:2@110:5] [debug variable = min2]
  %tmp.22 = icmp slt i26 %min2.1, 0, !dbg !288    ; [#uses=1 type=i1] [debug line = 110:5]
  br i1 %tmp.22, label %._crit_edge, label %1, !dbg !288 ; [debug line = 110:5]

; <label>:1                                       ; preds = %0
  %tmp.24 = zext i26 %min2.1 to i32, !dbg !299    ; [#uses=1 type=i32] [debug line = 112:10]
  %tmp.47 = icmp sgt i32 %tmp.24, %tmp.16, !dbg !299 ; [#uses=1 type=i1] [debug line = 112:10]
  br i1 %tmp.47, label %2, label %3, !dbg !299    ; [debug line = 112:10]

; <label>:2                                       ; preds = %1
  %cl = trunc i13 %s_w to i12, !dbg !300          ; [#uses=1 type=i12] [debug line = 113:3]
  call void @llvm.dbg.value(metadata !{i12 %cl}, i64 0, metadata !301), !dbg !300 ; [debug line = 113:3] [debug variable = cl]
  br label %._crit_edge, !dbg !300                ; [debug line = 113:3]

; <label>:3                                       ; preds = %1
  %cl.2 = trunc i26 %min2.1 to i12, !dbg !302     ; [#uses=1 type=i12] [debug line = 115:8]
...
._crit_edge:                                      ; preds = %3, %2, %0
  %cl.1 = phi i12 [ %cl, %2 ], [ %cl.2, %3 ], [ 0, %0 ] ; [#uses=2 type=i12]
  call void @llvm.dbg.value(metadata !{i26 %"cs[0]"}, i64 0, metadata !303), !dbg !305 ; [debug line = 21:19@118:5] [debug variable = in[0]]
  call void @llvm.dbg.value(metadata !{i26 %"cs[1]"}, i64 0, metadata !306), !dbg !305 ; [debug line = 21:19@118:5] [debug variable = in[1]]
  call void @llvm.dbg.value(metadata !{i26 %"cs[2]"}, i64 0, metadata !307), !dbg !305 ; [debug line = 21:19@118:5] [debug variable = in[2]]
  call void @llvm.dbg.value(metadata !{i26 %"cs[3]"}, i64 0, metadata !308), !dbg !305 ; [debug line = 21:19@118:5] [debug variable = in[3]]
  %"in[0].read.assign" = select i1 %tmp.i, i26 %"cs[0]", i26 %"cs[1]", !dbg !309 ; [#uses=2 type=i26] [debug line = 23:2@118:5]
  call void @llvm.dbg.value(metadata !{i26 %"in[0].read.assign"}, i64 0, metadata !303), !dbg !309 ; [debug line = 23:2@118:5] [debug variable = in[0]]
  call void @llvm.dbg.value(metadata !{i26 %"in[0].read.assign"}, i64 0, metadata !311), !dbg !309 ; [debug line = 23:2@118:5] [debug variable = max1]
  %"in[2].read.assign" = select i1 %tmp..i, i26 %"cs[2]", i26 %"cs[3]", !dbg !312 ; [#uses=2 type=i26] [debug line = 24:2@118:5]
  call void @llvm.dbg.value(metadata !{i26 %"in[2].read.assign"}, i64 0, metadata !307), !dbg !312 ; [debug line = 24:2@118:5] [debug variable = in[2]]
  call void @llvm.dbg.value(metadata !{i26 %"in[2].read.assign"}, i64 0, metadata !313), !dbg !312 ; [debug line = 24:2@118:5] [debug variable = max2]
  %tmp.98.i = icmp sgt i26 %"in[0].read.assign", %"in[2].read.assign", !dbg !314 ; [#uses=1 type=i1] [debug line = 25:2@118:5]
  %max1.1 = select i1 %tmp.98.i, i26 %"in[0].read.assign", i26 %"in[2].read.assign", !dbg !314 ; [#uses=3 type=i26] [debug line = 25:2@118:5]
  call void @llvm.dbg.value(metadata !{i26 %max1.1}, i64 0, metadata !311), !dbg !314 ; [debug line = 25:2@118:5] [debug variable = max1]
  %tmp.48 = sext i26 %max1.1 to i32, !dbg !304    ; [#uses=2 type=i32] [debug line = 118:5]
  %tmp.51 = icmp sgt i32 %tmp.48, %tmp.16, !dbg !304 ; [#uses=1 type=i1] [debug line = 118:5]
  br i1 %tmp.51, label %4, label %5, !dbg !304    ; [debug line = 118:5]

; <label>:4                                       ; preds = %._crit_edge
  %cr = trunc i13 %s_w to i12, !dbg !315          ; [#uses=1 type=i12] [debug line = 119:3]
  call void @llvm.dbg.value(metadata !{i12 %cr}, i64 0, metadata !316), !dbg !315 ; [debug line = 119:3] [debug variable = cr]
  br label %._crit_edge2, !dbg !315               ; [debug line = 119:3]

; <label>:5                                       ; preds = %._crit_edge
  %tmp.52 = icmp slt i26 %max1.1, 0, !dbg !317    ; [#uses=1 type=i1] [debug line = 120:10]
  %cr.2 = trunc i26 %max1.1 to i12, !dbg !318     ; [#uses=1 type=i12] [debug line = 123:8]
  call void @llvm.dbg.value(metadata !{i12 %cr.2}, i64 0, metadata !316), !dbg !318 ; [debug line = 123:8] [debug variable = cr]
  %.cr.2 = select i1 %tmp.52, i12 0, i12 %cr.2, !dbg !317 ; [#uses=1 type=i12] [debug line = 120:10]
  br label %._crit_edge2, !dbg !317               ; [debug line = 120:10]

._crit_edge2:                                     ; preds = %5, %4
  %cr.1 = phi i12 [ %cr, %4 ], [ %.cr.2, %5 ]     ; [#uses=1 type=i12]
  call void @llvm.dbg.value(metadata !{i26 %"rs[0]"}, i64 0, metadata !319), !dbg !321 ; [debug line = 13:19@126:5] [debug variable = in[0]]
  call void @llvm.dbg.value(metadata !{i26 %"rs[1]"}, i64 0, metadata !322), !dbg !321 ; [debug line = 13:19@126:5] [debug variable = in[1]]
  call void @llvm.dbg.value(metadata !{i26 %"rs[2]"}, i64 0, metadata !323), !dbg !321 ; [debug line = 13:19@126:5] [debug variable = in[2]]
  call void @llvm.dbg.value(metadata !{i26 %"rs[3]"}, i64 0, metadata !324), !dbg !321 ; [debug line = 13:19@126:5] [debug variable = in[3]]
  %tmp.i1 = icmp sgt i26 %"rs[0]", %"rs[1]", !dbg !325 ; [#uses=2 type=i1] [debug line = 15:2@126:5]
  %"in[1].read.assign.4" = select i1 %tmp.i1, i26 %"rs[1]", i26 %"rs[0]", !dbg !325 ; [#uses=2 type=i26] [debug line = 15:2@126:5]
  call void @llvm.dbg.value(metadata !{i26 %"in[1].read.assign.4"}, i64 0, metadata !322), !dbg !325 ; [debug line = 15:2@126:5] [debug variable = in[1]]
  call void @llvm.dbg.value(metadata !{i26 %"in[1].read.assign.4"}, i64 0, metadata !326), !dbg !325 ; [debug line = 15:2@126:5] [debug variable = min1]
  %tmp..i1 = icmp sgt i26 %"rs[2]", %"rs[3]", !dbg !327 ; [#uses=2 type=i1] [debug line = 16:2@126:5]
  %"in[3].read.assign.4" = select i1 %tmp..i1, i26 %"rs[3]", i26 %"rs[2]", !dbg !327 ; [#uses=2 type=i26] [debug line = 16:2@126:5]
  call void @llvm.dbg.value(metadata !{i26 %"in[3].read.assign.4"}, i64 0, metadata !324), !dbg !327 ; [debug line = 16:2@126:5] [debug variable = in[3]]
  call void @llvm.dbg.value(metadata !{i26 %"in[3].read.assign.4"}, i64 0, metadata !328), !dbg !327 ; [debug line = 16:2@126:5] [debug variable = min2]
  %tmp.97.i1 = icmp sgt i26 %"in[1].read.assign.4", %"in[3].read.assign.4", !dbg !329 ; [#uses=1 type=i1] [debug line = 17:2@126:5]
  %min2.3 = select i1 %tmp.97.i1, i26 %"in[3].read.assign.4", i26 %"in[1].read.assign.4", !dbg !329 ; [#uses=4 type=i26] [debug line = 17:2@126:5]
  call void @llvm.dbg.value(metadata !{i26 %min2.3}, i64 0, metadata !328), !dbg !329 ; [debug line = 17:2@126:5] [debug variable = min2]
  %tmp.54 = icmp slt i26 %min2.3, 0, !dbg !320    ; [#uses=1 type=i1] [debug line = 126:5]
  br i1 %tmp.54, label %._crit_edge3, label %6, !dbg !320 ; [debug line = 126:5]

; <label>:6                                       ; preds = %._crit_edge2
  %tmp.57 = zext i26 %min2.3 to i32, !dbg !330    ; [#uses=1 type=i32] [debug line = 128:10]
  %tmp.59 = icmp sgt i32 %tmp.57, %tmp.19, !dbg !330 ; [#uses=1 type=i1] [debug line = 128:10]
  br i1 %tmp.59, label %7, label %8, !dbg !330    ; [debug line = 128:10]

; <label>:7                                       ; preds = %6
  %rt = trunc i13 %s_h to i12, !dbg !331          ; [#uses=1 type=i12] [debug line = 129:3]
  call void @llvm.dbg.value(metadata !{i12 %rt}, i64 0, metadata !332), !dbg !331 ; [debug line = 129:3] [debug variable = rt]
  br label %._crit_edge3, !dbg !331               ; [debug line = 129:3]

; <label>:8                                       ; preds = %6
  %rt.2 = trunc i26 %min2.3 to i12, !dbg !333     ; [#uses=1 type=i12] [debug line = 131:8]
  call void @llvm.dbg.value(metadata !{i12 %rt.2}, i64 0, metadata !332), !dbg !333 ; [debug line = 131:8] [debug variable = rt]
  br label %._crit_edge3

._crit_edge3:                                     ; preds = %8, %7, %._crit_edge2
  %rt.1 = phi i12 [ %rt, %7 ], [ %rt.2, %8 ], [ 0, %._crit_edge2 ] ; [#uses=2 type=i12]
  call void @llvm.dbg.value(metadata !{i26 %"rs[0]"}, i64 0, metadata !334), !dbg !336 ; [debug line = 21:19@135:5] [debug variable = in[0]]
  call void @llvm.dbg.value(metadata !{i26 %"rs[1]"}, i64 0, metadata !337), !dbg !336 ; [debug line = 21:19@135:5] [debug variable = in[1]]
  call void @llvm.dbg.value(metadata !{i26 %"rs[2]"}, i64 0, metadata !338), !dbg !336 ; [debug line = 21:19@135:5] [debug variable = in[2]]
  call void @llvm.dbg.value(metadata !{i26 %"rs[3]"}, i64 0, metadata !339), !dbg !336 ; [debug line = 21:19@135:5] [debug variable = in[3]]
  %"in[0].read.assign.4" = select i1 %tmp.i1, i26 %"rs[0]", i26 %"rs[1]", !dbg !340 ; [#uses=2 type=i26] [debug line = 23:2@135:5]
  call void @llvm.dbg.value(metadata !{i26 %"in[0].read.assign.4"}, i64 0, metadata !334), !dbg !340 ; [debug line = 23:2@135:5] [debug variable = in[0]]
  call void @llvm.dbg.value(metadata !{i26 %"in[0].read.assign.4"}, i64 0, metadata !341), !dbg !340 ; [debug line = 23:2@135:5] [debug variable = max1]
  %"in[2].read.assign.4" = select i1 %tmp..i1, i26 %"rs[2]", i26 %"rs[3]", !dbg !342 ; [#uses=2 type=i26] [debug line = 24:2@135:5]
  call void @llvm.dbg.value(metadata !{i26 %"in[2].read.assign.4"}, i64 0, metadata !338), !dbg !342 ; [debug line = 24:2@135:5] [debug variable = in[2]]
  call void @llvm.dbg.value(metadata !{i26 %"in[2].read.assign.4"}, i64 0, metadata !343), !dbg !342 ; [debug line = 24:2@135:5] [debug variable = max2]
  %tmp.98.i1 = icmp sgt i26 %"in[0].read.assign.4", %"in[2].read.assign.4", !dbg !344 ; [#uses=1 type=i1] [debug line = 25:2@135:5]
  %max1.3 = select i1 %tmp.98.i1, i26 %"in[0].read.assign.4", i26 %"in[2].read.assign.4", !dbg !344 ; [#uses=3 type=i26] [debug line = 25:2@135:5]
  call void @llvm.dbg.value(metadata !{i26 %max1.3}, i64 0, metadata !341), !dbg !344 ; [debug line = 25:2@135:5] [debug variable = max1]
  %tmp.60 = sext i26 %max1.3 to i32, !dbg !335    ; [#uses=2 type=i32] [debug line = 135:5]
  %tmp.63 = icmp sgt i32 %tmp.60, %tmp.19, !dbg !335 ; [#uses=1 type=i1] [debug line = 135:5]
  br i1 %tmp.63, label %9, label %10, !dbg !335   ; [debug line = 135:5]

; <label>:9                                       ; preds = %._crit_edge3
  %rb = trunc i13 %s_h to i12, !dbg !345          ; [#uses=1 type=i12] [debug line = 136:3]
  call void @llvm.dbg.value(metadata !{i12 %rb}, i64 0, metadata !346), !dbg !345 ; [debug line = 136:3] [debug variable = rb]
  br label %._crit_edge4, !dbg !345               ; [debug line = 136:3]

; <label>:10                                      ; preds = %._crit_edge3
  %tmp.64 = icmp slt i26 %max1.3, 0, !dbg !347    ; [#uses=1 type=i1] [debug line = 137:10]
  %rb.2 = trunc i26 %max1.3 to i12, !dbg !348     ; [#uses=1 type=i12] [debug line = 140:8]
  call void @llvm.dbg.value(metadata !{i12 %rb.2}, i64 0, metadata !346), !dbg !348 ; [debug line = 140:8] [debug variable = rb]
  %.rb.2 = select i1 %tmp.64, i12 0, i12 %rb.2, !dbg !347 ; [#uses=1 type=i12] [debug line = 137:10]
  br label %._crit_edge4, !dbg !347               ; [debug line = 137:10]

._crit_edge4:                                     ; preds = %10, %9
  %rb.1 = phi i12 [ %rb, %9 ], [ %.rb.2, %10 ]    ; [#uses=1 type=i12]
  %tmp.66 = sext i12 %rt.1 to i32, !dbg !349      ; [#uses=2 type=i32] [debug line = 144:13]
  %tmp.68 = sext i12 %rb.1 to i32, !dbg !349      ; [#uses=1 type=i32] [debug line = 144:13]
  %tmp.69 = sub nsw i32 %tmp.66, %tmp.68, !dbg !349 ; [#uses=2 type=i32] [debug line = 144:13]
  %tmp.92 = trunc i32 %tmp.69 to i15              ; [#uses=2 type=i15]
  %abscond = icmp sgt i32 %tmp.69, 0              ; [#uses=1 type=i1]
  %tmp.97 = sub i15 0, %tmp.92                    ; [#uses=1 type=i15]
  %s_tile_h = select i1 %abscond, i15 %tmp.92, i15 %tmp.97 ; [#uses=3 type=i15]
  call void @llvm.dbg.value(metadata !{i15 %s_tile_h}, i64 0, metadata !350), !dbg !349 ; [debug line = 144:13] [debug variable = s_tile_h]
  %tmp.70 = sext i12 %cl.1 to i32, !dbg !351      ; [#uses=2 type=i32] [debug line = 145:13]
  %tmp.71 = sext i12 %cr.1 to i32, !dbg !351      ; [#uses=1 type=i32] [debug line = 145:13]
  %tmp.72 = sub nsw i32 %tmp.70, %tmp.71, !dbg !351 ; [#uses=2 type=i32] [debug line = 145:13]
  %tmp.98 = trunc i32 %tmp.72 to i15              ; [#uses=2 type=i15]
  %abscond1 = icmp sgt i32 %tmp.72, 0             ; [#uses=1 type=i1]
  %tmp.99 = sub i15 0, %tmp.98                    ; [#uses=1 type=i15]
  %s_tile_w_r2.5 = select i1 %abscond1, i15 %tmp.98, i15 %tmp.99 ; [#uses=6 type=i15]
  call void @llvm.dbg.value(metadata !{i15 %s_tile_w_r2.5}, i64 0, metadata !352), !dbg !353 ; [debug line = 194:3] [debug variable = s_tile_w_r2]
  call void @llvm.dbg.value(metadata !{i15 %s_tile_w_r2.5}, i64 0, metadata !355), !dbg !351 ; [debug line = 145:13] [debug variable = s_tile_w]
  call void @llvm.dbg.value(metadata !{i15 %s_tile_w_r2.5}, i64 0, metadata !356), !dbg !357 ; [debug line = 157:2] [debug variable = s_tile_w_r]
  %tmp.73 = icmp slt i15 %s_tile_h, 1, !dbg !358  ; [#uses=1 type=i1] [debug line = 169:2]
  %s_tile_h.1 = select i1 %tmp.73, i15 1, i15 %s_tile_h, !dbg !358 ; [#uses=1 type=i15] [debug line = 169:2]
  call void @llvm.dbg.value(metadata !{i15 %s_tile_h.1}, i64 0, metadata !350), !dbg !358 ; [debug line = 169:2] [debug variable = s_tile_h]
  store i15 %s_tile_h.1, i15* %hs, align 2, !dbg !359 ; [debug line = 170:3]
  call void @llvm.dbg.value(metadata !{i15 %s_tile_w_r2.5}, i64 0, metadata !360), !dbg !362 ; [debug line = 28:18@177:8] [debug variable = n]
  %m = trunc i15 %s_tile_w_r2.5 to i2, !dbg !363  ; [#uses=2 type=i2] [debug line = 30:2@177:8]
  ...
  switch i2 %m, label %._crit_edge5 [
    i2 0, label %11
    i2 1, label %12
    i2 -2, label %13
    i2 -1, label %14
  ], !dbg !368                                    ; [debug line = 180:2]

; <label>:11                                      ; preds = %._crit_edge4
  %s_tile_w_r2 = add i15 %s_tile_w_r2.5, 2, !dbg !369 ; [#uses=1 type=i15] [debug line = 182:3]
  call void @llvm.dbg.value(metadata !{i15 %s_tile_w_r2}, i64 0, metadata !352), !dbg !369 ; [debug line = 182:3] [debug variable = s_tile_w_r2]
  br label %._crit_edge5, !dbg !370               ; [debug line = 183:3]

; <label>:12                                      ; preds = %._crit_edge4
  %s_tile_w_r2.1 = add i15 %s_tile_w_r2.5, 5, !dbg !371 ; [#uses=1 type=i15] [debug line = 185:3]
  call void @llvm.dbg.value(metadata !{i15 %s_tile_w_r2.1}, i64 0, metadata !352), !dbg !371 ; [debug line = 185:3] [debug variable = s_tile_w_r2]
  br label %._crit_edge5, !dbg !372               ; [debug line = 186:3]

; <label>:13                                      ; preds = %._crit_edge4
  %s_tile_w_r2.2 = add i15 %s_tile_w_r2.5, 4, !dbg !373 ; [#uses=1 type=i15] [debug line = 188:3]
  call void @llvm.dbg.value(metadata !{i15 %s_tile_w_r2.2}, i64 0, metadata !352), !dbg !373 ; [debug line = 188:3] [debug variable = s_tile_w_r2]
  br label %._crit_edge5, !dbg !374               ; [debug line = 189:3]

; <label>:14                                      ; preds = %._crit_edge4
  %s_tile_w_r2.3 = add i15 %s_tile_w_r2.5, 3, !dbg !375 ; [#uses=1 type=i15] [debug line = 191:3]
  call void @llvm.dbg.value(metadata !{i15 %s_tile_w_r2.3}, i64 0, metadata !352), !dbg !375 ; [debug line = 191:3] [debug variable = s_tile_w_r2]
  br label %._crit_edge5, !dbg !376               ; [debug line = 192:3]

._crit_edge5:                                     ; preds = %14, %13, %12, %11, %._crit_edge4
  %s_tile_w_r1 = phi i15 [ %s_tile_w_r2.3, %14 ], [ %s_tile_w_r2.2, %13 ], [ %s_tile_w_r2.1, %12 ], [ %s_tile_w_r2, %11 ], [ %s_tile_w_r2.5, %._crit_edge4 ] ; [#uses=1 type=i15]
  store i15 %s_tile_w_r1, i15* %ws, align 2, !dbg !377 ; [debug line = 206:2]
  store i15 %s_tile_h, i15* %hs_p, align 2, !dbg !378 ; [debug line = 207:2]
  %tmp.74 = sext i26 %min2.1 to i32, !dbg !379    ; [#uses=1 type=i32] [debug line = 209:5]
  %tmp.77 = sext i8 %w_div to i32, !dbg !379      ; [#uses=1 type=i32] [debug line = 209:5]
  %tmp.78 = shl nsw i32 %tmp.77, 3, !dbg !379     ; [#uses=2 type=i32] [debug line = 209:5]
  %tmp.79 = add nsw i32 %tmp.78, %tmp.16, !dbg !379 ; [#uses=1 type=i32] [debug line = 209:5]
  %tmp.80 = icmp slt i32 %tmp.74, %tmp.79, !dbg !379 ; [#uses=1 type=i1] [debug line = 209:5]
  %tmp.81 = sub nsw i32 0, %tmp.78, !dbg !380     ; [#uses=1 type=i32] [debug line = 209:33]
  %tmp.84 = icmp sgt i32 %tmp.48, %tmp.81, !dbg !380 ; [#uses=1 type=i1] [debug line = 209:33]
  %or.cond = and i1 %tmp.80, %tmp.84, !dbg !380   ; [#uses=1 type=i1] [debug line = 209:33]
  br i1 %or.cond, label %15, label %._crit_edge6, !dbg !379 ; [debug line = 209:5]

; <label>:15                                      ; preds = %._crit_edge5
  %tmp.85 = sext i8 %h_div to i32, !dbg !381      ; [#uses=1 type=i32] [debug line = 209:59]
  %tmp.88 = shl nsw i32 %tmp.85, 3, !dbg !381     ; [#uses=2 type=i32] [debug line = 209:59]
  %tmp.89 = sub nsw i32 0, %tmp.88, !dbg !381     ; [#uses=1 type=i32] [debug line = 209:59]
  %tmp.90 = icmp sgt i32 %tmp.60, %tmp.89, !dbg !381 ; [#uses=1 type=i1] [debug line = 209:59]
  br i1 %tmp.90, label %16, label %._crit_edge6, !dbg !381 ; [debug line = 209:59]

; <label>:16                                      ; preds = %15
  %tmp.91 = sext i26 %min2.3 to i32, !dbg !382    ; [#uses=1 type=i32] [debug line = 209:85]
  %tmp.93 = add nsw i32 %tmp.88, %tmp.19, !dbg !382 ; [#uses=1 type=i32] [debug line = 209:85]
  %tmp.94 = icmp slt i32 %tmp.91, %tmp.93, !dbg !382 ; [#uses=1 type=i1] [debug line = 209:85]
  br i1 %tmp.94, label %._crit_edge9, label %._crit_edge6, !dbg !382 ; [debug line = 209:85]

._crit_edge6:                                     ; preds = %16, %15, %._crit_edge5
  br label %._crit_edge9

._crit_edge9:                                     ; preds = %._crit_edge6, %16
  %storemerge1 = phi i1 [ false, %._crit_edge6 ], [ true, %16 ] ; [#uses=1 type=i1]
  store i1 %storemerge1, i1* %tile_valid, align 1, !dbg !383 ; [debug line = 210:3]
  store i12 %cl.1, i12* %left_col, align 2, !dbg !384 ; [debug line = 214:2]
  store i12 %rt.1, i12* %top_row, align 2, !dbg !385 ; [debug line = 215:2]
  %tmp.95 = mul nsw i32 %tmp.16, %tmp.66, !dbg !386 ; [#uses=1 type=i32] [debug line = 216:2]
  %tmp.96 = add nsw i32 %tmp.70, %tmp.95, !dbg !386 ; [#uses=1 type=i32] [debug line = 216:2]
  store i32 %tmp.96, i32* %baddr, align 4, !dbg !386 ; [debug line = 216:2]
  ret void, !dbg !387                             ; [debug line = 218:1]
}
...
!315 = metadata !{i32 119, i32 3, metadata !252, null}
!316 = metadata !{i32 786688, metadata !252, metadata !"cr", metadata !6, i32 71, metadata !22, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!345 = metadata !{i32 136, i32 3, metadata !252, null}
!346 = metadata !{i32 786688, metadata !252, metadata !"rb", metadata !6, i32 71, metadata !22, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!368 = metadata !{i32 180, i32 2, metadata !252, null}
!369 = metadata !{i32 182, i32 3, metadata !354, null}
!370 = metadata !{i32 183, i32 3, metadata !354, null}
!371 = metadata !{i32 185, i32 3, metadata !354, null}
!372 = metadata !{i32 186, i32 3, metadata !354, null}
!373 = metadata !{i32 188, i32 3, metadata !354, null}
!374 = metadata !{i32 189, i32 3, metadata !354, null}
!375 = metadata !{i32 191, i32 3, metadata !354, null}
!376 = metadata !{i32 192, i32 3, metadata !354, null}
!377 = metadata !{i32 206, i32 2, metadata !252, null}
!378 = metadata !{i32 207, i32 2, metadata !252, null}
!379 = metadata !{i32 209, i32 5, metadata !252, null}
!380 = metadata !{i32 209, i32 33, metadata !252, null}
!381 = metadata !{i32 209, i32 59, metadata !252, null}
!382 = metadata !{i32 209, i32 85, metadata !252, null}
!383 = metadata !{i32 210, i32 3, metadata !252, null}
!384 = metadata !{i32 214, i32 2, metadata !252, null}
!385 = metadata !{i32 215, i32 2, metadata !252, null}
!386 = metadata !{i32 216, i32 2, metadata !252, null}
!387 = metadata !{i32 218, i32 1, metadata !252, null}
