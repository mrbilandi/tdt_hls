...
#ifndef __tdt_mac_muladd_13cud__HH__
#define __tdt_mac_muladd_13cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(tdt_mac_muladd_13cud) {
    ...
    SC_CTOR(tdt_mac_muladd_13cud):  simcore_mac_0_U ("simcore_mac_0_U") {
